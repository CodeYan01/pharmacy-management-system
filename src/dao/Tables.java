...
public class Tables {
    ...
    public static void main(String[] args) {
        try {
            ...
            //st.executeUpdate("Insert into appuser (userRole,name,dob,mobileNumber,email,username,password,address) values('Admin','Admin','16-12-1992','000011122','admin@email.com','admin','admin','India')");
